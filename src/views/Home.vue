                      ...
                      <v-list>
                        ...
                        <v-list-item>
                          ...
                          <v-list-item-content align="right">
                            ...
                            <v-list-item-subtitle
                              >$ 1500 of 1,200</v-list-item-subtitle
                            >
                          </v-list-item-content>
                        </v-list-item>
                        <v-divider inset></v-divider>
                        ...
                        <v-list-item>
                          ...
                          <v-list-item-content align="right">
                            ...
                            <v-list-item-subtitle
                              >$ 100 of 350</v-list-item-subtitle
                            >
                          </v-list-item-content>
                        </v-list-item>
                      </v-list>
              ...
              <v-container>
                <v-row>
                  <v-col cols="12" md="12">
                    <v-list-item>
                      <v-list-item-avatar>
                        <v-img src="card2.jpg"></v-img>
                      </v-list-item-avatar>
                      <v-list-item-content>
                        <v-list-item-title>AAA IdeaPro</v-list-item-title>
                        <v-list-item-subtitle
                          >aaaideapro@gmail.com</v-list-item-subtitle
                        >
                      </v-list-item-content>
                      <v-list-item-action
                        ><v-icon
                  ...
                  <v-col cols="12" md="12">
                    <v-list-item>
                      ...
                      <v-list-item-content>
                        ...
                        <v-list-item-title>$ 15,000</v-list-item-title>
                      </v-list-item-content>
                      <v-list-item-action>
                  ...
                  <v-col cols="12" md="12">
                    <v-list-item>
                      ...
                      <v-list-item-content>
                        ...
                        >
                        <v-list-item-title>$ 6,500</v-list-item-title>
                      </v-list-item-content>
                      <v-list-item-action>
                  ...
                  <v-col cols="12" md="12">
                    <v-list-item>
                      ...
                      <v-list-item-content>
                        ...
                        >
                        <v-list-item-title>$ 20,500</v-list-item-title>
                      </v-list-item-content>
                      <v-list-item-action>
